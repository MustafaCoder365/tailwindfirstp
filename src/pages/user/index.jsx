...
import PublicNavbar from "../../components/PublicNavbar"; // استيراد النافبار فقط – لا يوجد أي كود آخر خاص بالنافبار هنا
import {
  FaUpload,
  FaShoppingCart,
  FaBell,
...
export default function UserHome() {
  ...
  useEffect(() => {
    // 🔐 REMOVE MOCK AUTH FOR PRODUCTION
  ...
  return (
    <>
      {/* هنا فقط نستدعي الـ PublicNavbar، دون تضمين أي كود داخلي خاص بالنافبار */}
